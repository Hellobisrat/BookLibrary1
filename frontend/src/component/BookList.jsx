        ...
        {books.map((book,index)=>(
          <Link key={index} to={`/book/${book._id}`}>
            <div className=' cursor-pointer w-[9rem] md:w-[10.5rem] xl:w-[11rem] shadow-sm hover:shadow-md rounded-b-md'>
              <div className='min-w-[9rem] md:min-w-[10.5rem] xl:min-w-[11rem]  bg-[#252422] h-[12rem] md:h-[13.5rem] lg:h-[13rem] xl:h-[15rem]'>
                <img
                  src={book.image}
                  alt='book_img'
                  className='min-w-[9rem] md:mim-w-[10.5rem] xl:min-w-[11rem]
                  h-[12rem] md:h-[13.5rem] lg:h-[13rem] xl:h-[15rem] bg-[#252422]'/>
              </div>
