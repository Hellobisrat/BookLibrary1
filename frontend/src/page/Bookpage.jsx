        ...
        <div className='flex justify-between items-center'>
          ...
          {user?._id === book?.user?._id && (
            <div className='text-2xl font-bold -mt-2 relative'>
              <span className='cursor-pointer tracking-widest' onClick={()=>setOpen(!open)}>
                ...
              </span>
              {open && (
                <div className='absolute bg-[#f5f5f5] shadow-md pb-2
                px-5 text-base font-normal right-0 top-10'>
